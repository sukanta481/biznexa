                    ...
                    {showProfile && user && (
                        <div className="absolute right-0 top-full mt-2 w-56 bg-[#0a1628]/98 backdrop-blur-2xl border border-white/[0.08] rounded-2xl shadow-2xl shadow-black/40 overflow-hidden z-50">
                            <div className="p-4 border-b border-white/[0.05]">
                                ...
                                <span className="inline-block mt-1 text-[9px] font-bold uppercase tracking-widest text-cyan-400 bg-cyan-500/10 px-2 py-0.5 rounded border border-cyan-500/20">{user.role}</span>
                            </div>
                            <div className="py-1">
                            ...
                            <div className="border-t border-white/[0.05] py-1">
                                <button
                                    ...
                                    className="flex items-center gap-3 w-full px-4 py-2.5 text-[13px] text-rose-400 hover:bg-rose-500/[0.06] transition-all"
                                >
