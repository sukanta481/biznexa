        ...
        <div className="bg-[#192540]/60 backdrop-blur-[20px] border border-[#40485d]/15 rounded-xl p-8 shadow-2xl relative overflow-hidden">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              <label className="font-label text-[11px] uppercase tracking-wider text-primary font-bold ml-1" htmlFor="username">
                Username / Email
              </label>
              <div className="relative group">
                ...
                <input
                  className="w-full bg-[#192540] border border-[#40485d]/20 rounded-lg py-3.5 pl-11 pr-4 text-sm text-on-surface placeholder:text-[#6d758c]/50 focus:ring-1 focus:ring-primary/30 focus:border-primary/30 transition-all outline-none"
                  id="username"
                  name="username"
                  placeholder="admin or admin&#64;biznexa.studio"
                  type="text"
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-1">
                <label className="font-label text-[11px] uppercase tracking-wider text-primary font-bold" htmlFor="password">
                  Password
                </label>
              </div>
              <div className="relative group">
                ...
                <input
                  className="w-full bg-[#192540] border border-[#40485d]/20 rounded-lg py-3.5 pl-11 pr-12 text-sm text-on-surface placeholder:text-[#6d758c]/50 focus:ring-1 focus:ring-primary/30 focus:border-primary/30 transition-all outline-none"
                  id="password"
                  name="password"
                  placeholder="••••••••••••"
                ...
                <button
                  type="button"
                  className="absolute inset-y-0 right-0 pr-4 flex items-center text-[#6d758c] hover:text-primary transition-colors"
            ...
            <div className="flex items-center gap-3 py-1">
              <label className="relative inline-flex h-5 w-9 items-center rounded-full bg-[#192540] cursor-pointer">
                <input
              ...
              <span className="font-body text-xs text-[#a3aac4]">Remember me for 7 days</span>
            </div>

            <button
              className="w-full py-4 bg-[#69f6b8] text-[#00452d] font-headline font-bold text-sm rounded-lg relative group overflow-hidden transition-all active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed"
              type="submit"
              disabled={isPending}
            >
